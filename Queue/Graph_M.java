...
//     static HashMap<String, Integer> initialDistances;

//     public Graph_M() {
//         vtces = new HashMap<>();
//         initialDistances = new HashMap<>();
//         initialDistances.put("Noida Sector 62~B", 5);
//         initialDistances.put("Botanical Garden~B", 3);
//         initialDistances.put("Rashtrapathi Bhawan~B", 6);
//         initialDistances.put("Bahai Temple~AB", 7);
//         initialDistances.put("Qutub Minar~kk", 11);
//         initialDistances.put("Bangla Sahib~B", 10);
//         initialDistances.put("Jantar Mantar~LB", 1);
//         initialDistances.put("Agrasen Ki Baoli~C", 4);
//         initialDistances.put("Red Fort~BB", 9);
//         initialDistances.put("India Gate~AP", 9);
//     }
...
//     public int dijkstra(String src, String des, boolean nan, int initialDistance) {
//         int val = 0;
...
//             if (key.equals(src)) {
//                 np.cost = initialDistance; // Set initial distance from user's location
//                 np.psf = key;
//             }
...
//                 case 3:
//                     // Fetch the initial distance from the map based on the user's selected source
//                     // location
//                     System.out.print("Enter your current location : ");
//                     String userLocation = inp.readLine();
//                     int initialDistance = initialDistances.getOrDefault(userLocation, -1);
//                     if (initialDistance == -1) {
//                         System.out.println("Invalid user location!");
//                         break;
//                     }

//                     // Proceed with calculating the shortest distance
//                     ArrayList<String> keys = new ArrayList<>(vtces.keySet());
...
//                                 + g.dijkstra(st1, st2, false, initialDistance) + "KM\n");
//                     break;
...
//                             + ((double) g.dijkstra(sat1, sat2, true, distance) / 60) + " MINUTES\n\n");
